...
<body>
<div class="container-fluid bg-gray-500 d-flex myCSS" style="height: 130px">
  <img class="h-100 p-4" src="https://rubyriverhotel.com.vn/wp-content/uploads/2020/10/logo-hotel-ruby.png" alt="">
  ...
  <div class="container-fluid text-end my-4 me-4">
    <span class="badge text-bg-warning mt-3">Nam_Huỳnh_Furama</span>
  </div>
</div>
...
<div class="container-fluid" style="height: 520px;background: cornflowerblue">
  <div class="row mx-3">
    <div class="col-2">
    ...
    <div class="col-10">
      <img style="width: 100%;height: 520px" class="img-fluid" src="https://resortdanang.info/wp-content/uploads/2019/01/resort-furama-da-nang.jpg" alt="">
    </div>
  </div>
</div>
